...
- Data channel support in the Android mediasoup client bridge.

### Changed

- Updated WebRTC compatibility handling for the current release line.
- Added Android 15+ 16 KB page-alignment support for native binaries.
- Refreshed Maven Central publishing configuration for the current artifact layout.
