...
{
SendTransportListenerJni::SendTransportListenerJni(JNIEnv* env, const JavaRef<jobject>& j_listener)
{
	(void)env;
...
RecvTransportListenerJni::RecvTransportListenerJni(JNIEnv* env, const JavaRef<jobject>& j_listener)
{
	(void)env;
	j_listener_ = j_listener;
}
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Transport_GetId(
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Transport_GetConnectionState(
  JNIEnv* env, const JavaParamRef<jobject>& j_transport)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Transport_GetAppData(
  JNIEnv* env, const JavaParamRef<jobject>& j_transport)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Transport_GetStats(
  JNIEnv* env, const JavaParamRef<jobject>& j_transport)
{
	MSC_TRACE();
	...
	catch (const std::exception& e)
	{
		...
		return webrtc::ScopedJavaLocalRef<jstring>();
	}
}
...
static webrtc::ScopedJavaLocalRef<jobject> JNI_SendTransport_Produce(
  JNIEnv* env,
  jlong j_transport,
  ...
  const JavaParamRef<jstring>& j_appData)
{
	...
	catch (const std::exception& e)
	{
		MSC_ERROR("%s", e.what());
		THROW_MEDIASOUP_CLIENT_EXCEPTION(env, e);
		return webrtc::ScopedJavaLocalRef<jobject>();
	}
}

webrtc::ScopedJavaLocalRef<jobject> JNI_SendTransport_ProduceData(
  JNIEnv* env,
  jlong j_transport,
  const JavaParamRef<jobject>& j_listener,
...
static webrtc::ScopedJavaLocalRef<jobject> JNI_RecvTransport_Consume(
  JNIEnv* env,
  jlong j_transport,
  const JavaParamRef<jobject>& j_listener,
...
static webrtc::ScopedJavaLocalRef<jobject> JNI_RecvTransport_ConsumeData(
  JNIEnv* env,
  jlong j_transport,
  const JavaParamRef<jobject>& j_listener,
  const JavaParamRef<jstring>& j_id,
  ...
  JNIEnv* env, SendTransport* transport, SendTransportListenerJni* listener)
{
	...
	return webrtc::ScopedJavaLocalRef<jobject>(env, j_transport.Release());
}
