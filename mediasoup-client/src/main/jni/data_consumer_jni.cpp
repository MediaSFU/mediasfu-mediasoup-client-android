...
void DataConsumerListenerJni::OnMessage(DataConsumer* dataConsumer, const webrtc::DataBuffer& buffer)
{
	...
	webrtc::ScopedJavaLocalRef<jobject> j_buffer =
	  Java_DataConsumer_generateBuffer(env, byte_buffer, buffer.binary);
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetDataProducerId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetLocalId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetSctpStreamParameters(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetLabel(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetProtocol(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_DataConsumer_GetAppData(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
webrtc::ScopedJavaLocalRef<jobject> NativeToJavaDataConsumer(
