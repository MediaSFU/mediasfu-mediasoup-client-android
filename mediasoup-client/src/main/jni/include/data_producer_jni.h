...
{
public:
	DataProducerListenerJni(JNIEnv* env, const JavaRef<jobject>& j_listener);
...
public:
	...
	{
		(void)env;
		j_data_producer_ = j_data_producer;
	}

private:
	webrtc::ScopedJavaGlobalRef<jobject> j_listener_;
	webrtc::ScopedJavaGlobalRef<jobject> j_data_producer_;
};
