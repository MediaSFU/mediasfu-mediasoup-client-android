...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetNativeId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetLocalId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetProducerId(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetRtpParameters(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetAppData(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
...
static webrtc::ScopedJavaLocalRef<jstring> JNI_Consumer_GetStats(JNIEnv* env, jlong j_consumer)
{
	MSC_TRACE();
